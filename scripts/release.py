...
class ReleaseManager:
    ...
    VERSION_FILE = '../src/grafliq/__init__.py'
    DEFAULT_CHANGE = 'patch'
    DEFAULT_IS_BETA = False
    PIPFILE = '../Pipfile'
    PYTHON_VERSION = 'python{version}'
    PYPI_PACKAGE_NAME = 'grafliq'
    MAX_MINOR = 50
    MAX_PATCH = 50
    ...
    def _get_current_version(self):
        """
        gets current grafliq version from grafliq package.

        :returns: tuple(int major, int minor, int patch, str beta)
        :rtype: tuple
        """

        with io.open(self.VERSION_FILE, 'rt', encoding='utf8') as version_file:
